                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="quiz_weight" class="form-select">
                            <option value="10" {{ old('quiz_weight', $course->quiz_weight ?? 20) == 10 ? 'selected' : '' }}>10</option>
                            <option value="20" {{ old('quiz_weight', $course->quiz_weight ?? 20) == 20 ? 'selected' : '' }}>20</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Assignment</label>
                        <select name="assignment_weight" class="form-select">
                            <option value="10" {{ old('assignment_weight', $course->assignment_weight ?? 20) == 10 ? 'selected' : '' }}>10</option>
                            <option value="20" {{ old('assignment_weight', $course->assignment_weight ?? 20) == 20 ? 'selected' : '' }}>20</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="final_weight" class="form-select">
                            <option value="30" {{ old('final_weight', $course->final_weight ?? 30) == 30 ? 'selected' : '' }}>30</option>
                            <option value="40" {{ old('final_weight', $course->final_weight ?? 30) == 40 ? 'selected' : '' }}>40</option>
                        </select>
                    </div>
                </div>
