...
@endphp
<style>
    .profile-panel .profile-hero { display: flex; flex-direction: column; align-items: center; padding: 2rem 1rem 2.5rem; margin-bottom: 1rem; }
    .profile-panel .profile-hero .name { font-size: 1.25rem; font-weight: 700; color: #0f172a; margin-bottom: 0.75rem; }
    .profile-panel .profile-hero .avatar { width: 96px; height: 96px; border-radius: 50%; background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); color: #fff; display: flex; align-items: center; justify-content: center; font-size: 2rem; font-weight: 600; margin-bottom: 0.75rem; }
    .profile-panel .profile-hero .role-chip { padding: 0.35rem 0.85rem; font-size: 0.75rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; background: #0f172a; color: #fff; border-radius: 9999px; }
